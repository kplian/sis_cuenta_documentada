...
Phx.vista.PagoSimpleDet = {
    ...
    loadValoresIniciales: function() {
    	Phx.vista.PagoSimpleDet.superclass.loadValoresIniciales.call(this);
        //this.Cmp.tipo.setValue(this.tipoDoc); 
        
   },
   capturaFiltros:function(combo, record, index){
        this.store.baseParams.tipo = this.tipoDoc;
        Phx.vista.PagoSimpleDet.superclass.capturaFiltros.call(this,combo, record, index);
    },
	...
	fields: [
		...
		'estacion', 'id_punto_venta', 'nombre', 'id_agencia', 'codigo_noiata','desc_funcionario2','id_funcionario','sw_pgs','nota_debito_agencia','nro_tramite_aux'
	],

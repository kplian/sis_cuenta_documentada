...
<script>
	Phx.vista.CuentaDocReporte = {
		...
		nombreVista: 'CuentaDocReporte',
		ActList:'../../sis_cuenta_documentada/control/CuentaDoc/listarCuentaDocReporte',
		...
		constructor: function(config) {
			...
			Phx.vista.CuentaDocReporte.superclass.constructor.call(this,config);
		...
		preparaMenu:function(n){
			...
			var tb =this.tbar;
			Phx.vista.CuentaDocReporte.superclass.preparaMenu.call(this,n);
		...
		liberaMenu:function(){
			var tb = Phx.vista.CuentaDocReporte.superclass.liberaMenu.call(this);
			if(tb){

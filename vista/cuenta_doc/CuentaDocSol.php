...
<script>
    Phx.vista.CuentaDocSol = {
        ...
        constructor: function(config) {
            ...
            //Inicio #8
            this.Cmp.cantidad_personas.on('blur', function(cmp, val, a){
                this.Cmp.id_funcionarios.hide();
                this.Cmp.id_funcionarios.allowBlank = true;

                if(cmp.value > 1){
                    this.Cmp.id_funcionarios.show();
                    this.Cmp.id_funcionarios.allowBlank = false;
                }
            }, this)
            //Fin #8
        },
...
//#1 				24/09/2018		EGS
        ...
        ocultarMostrarComp: function(codigo,limpiar=false){
            ...
            if(codigo=='SOLVIA') {
                ...
                //Inicio #8
                console.log('ss',this.Cmp.cantidad_personas.getValue());
                if(this.Cmp.cantidad_personas.getValue() > 1) {
                    this.Cmp.id_funcionarios.show();
                    this.Cmp.id_funcionarios.allowBlank = false;
                }
                //Fin #8

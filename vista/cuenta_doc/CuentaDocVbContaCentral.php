    ...
    sigEstado: function(){
        ...
        Ext.Ajax.request({
            ...
            success: function(resp){
                Phx.CP.loadingHide();
                var reg = Ext.util.JSON.decode(Ext.util.Format.trim(resp.responseText)).ROOT;
                //Si ya se defini� la forma de devoluci�n, hace las validaciones correspondientes antes de abrir el wizard
                console.log(reg.datos.tipo_rendicion)
                //Si la rendici�n es final obliga a que realice la introducci�n de datos de la Devoluci�n/Reposici�n

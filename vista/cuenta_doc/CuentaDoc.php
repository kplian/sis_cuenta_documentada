...
CD 		   				05/05/2016  			Creación de archivo
...
<script>
    Phx.vista.CuentaDoc = Ext.extend(Phx.gridInterfaz,{
        ...
        Atributos:[
            ...
            //Inicio #8
            {
                config: {
                    ...
                    blankText: 'Debe seleccionar los funcionarios extras',
                    store: new Ext.data.JsonStore({
                        ...
                        totalProperty: 'total',
                        fields: ['id_funcionario', 'codigo', 'desc_person'],
                        remoteSort: true,
                        baseParams: { par_filtro: 'PERSON.nombre_completo2' }
                    }),
                    valueField: 'id_funcionario',
                    displayField: 'desc_person',
                    tpl: '<tpl for=".">  <div class="x-combo-list-item"><div class="awesomecombo-item {checked}"> {desc_person} </div></div> </tpl>',
                    ...
                    // hidden: true,
                    renderer: function (value, p, record){return String.format('{0}', record.data['funcinarios']);}
                },
                type: 'AwesomeCombo',
                id_grupo: 0,
                grid: true,
        ...
        fields: [
            ...
            {name: 'id_funcionarios', type: 'string'}, //#8
            {name: 'funcinarios', type: 'string'} //#8
        ],
        sortInfo:{
            field: 'id_cuenta_doc',
            direction: 'ASC'

...
CREATE OR REPLACE FUNCTION cd.f_lista_depto_conta_wf_sel (
...
BEGIN
  v_nombre_funcion ='cd.f_lista_depto_conta_wf_sel';
    ...
    inner join param.tdepto dep on dep.id_depto = cd.id_depto_conta

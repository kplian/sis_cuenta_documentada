CREATE OR REPLACE FUNCTION cd.f_lista_depto_lb_pago_simple_wf (
...
***************************************************************************
 SCRIPT: 		cd.f_lista_depto_lb_pago_simple_wf
...
BEGIN
  v_nombre_funcion ='cd.f_lista_depto_lb_pago_simple_wf';

...
CREATE OR REPLACE FUNCTION cd.f_lista_funcionario_gerente_cd_wf_sel (
...
***************************************************************************
 SCRIPT: 		cd.f_lista_funcionario_gerente_cd_wf_sel
...
BEGIN
    v_nombre_funcion ='cd.f_lista_funcionario_gerente_cd_wf_sel';
